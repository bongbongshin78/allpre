...
import com.bongbong.alprev.mlkit.md.common.FrameMetadata;
import com.bongbong.alprev.mlkit.md.common.GraphicOverlayLabel;
import com.bongbong.alprev.mlkit.md.common.VisionImageProcessor;
import com.bongbong.alprev.mlkit.md.java.camera.CameraSource;
import com.bongbong.alprev.mlkit.md.java.camera.CameraSourcePreview;
import com.bongbong.alprev.mlkit.md.java.camera.GraphicOverlay;
import com.bongbong.alprev.mlkit.md.java.camera.WorkflowModel;
import com.bongbong.alprev.mlkit.md.java.camera.WorkflowModel.WorkflowState;
import com.bongbong.alprev.mlkit.md.java.cloudimagelabeling.CloudImageLabelingProcessor;
import com.bongbong.alprev.mlkit.md.java.objectdetection.DetectedObject;
import com.bongbong.alprev.mlkit.md.java.objectdetection.MultiObjectProcessor;
import com.bongbong.alprev.mlkit.md.java.objectdetection.ProminentObjectProcessor;
import com.bongbong.alprev.mlkit.md.java.productsearch.BottomSheetScrimView;
import com.bongbong.alprev.mlkit.md.java.productsearch.Product;
import com.bongbong.alprev.mlkit.md.java.productsearch.ProductAdapter;

import com.bongbong.alprev.mlkit.md.java.productsearch.SearchedObject;
import com.bongbong.alprev.mlkit.md.java.settings.PreferenceUtils;
import com.bongbong.alprev.mlkit.md.java.settings.SettingsActivity;
import com.bongbong.alprev.mlkit.md.java.PostingLinkActivity;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;
//sean
import com.bongbong.alprev.mlkit.md.java.productsearch.SearchEngineCloud;
...
public class LiveObjectCloudDetectionActivity extends AppCompatActivity implements OnClickListener {
  ...
  private boolean checkblogpost(List<Product> pd){
    ...
    for(int i=0; i < pd.size(); i++) {
      ...
      if (pd.get(i).title.contains("Milk")) {
        //Toast.makeText(getApplicationContext(), "Metal", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://34.70.3.238/milk/"));
        startActivity(view);
        flag = 1;
        break;
      }
      else if (pd.get(i).title.contains("Egg") ) {
        //Toast.makeText(getApplicationContext(), "can", Toast.LENGTH_LONG).show();
        Log.d(TAG, "Egg: " + pd.get(i).title);
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://34.70.3.238/egg/"));
        flag = 1;
        startActivity(view);
        break;
      }
      else if (pd.get(i).title.contains("Wheat") ) {
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://34.70.3.238/wheat/"));
        startActivity(view);
        flag = 1;
        break;
      }
      //box
      else if (pd.get(i).title.contains("Fruit")) {
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://34.70.3.238/fruit/"));
        startActivity(view);
        flag = 1;
        break;
      }
      else if (pd.get(i).title.contains("Nut") ) {
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://34.70.3.238/nut/"));
        flag = 1;
        startActivity(view);
      }
      else if (pd.get(i).title.contains("Seafood") ) {
        //Toast.makeText(getApplicationContext(), "Glass", Toast.LENGTH_LONG).show();
        Log.d(TAG, "Glass & !Plastic bottle : " + pd.get(i).title);
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://34.70.3.238/fish/"));
        startActivity(view);
        flag = 1;
        break;
      }
              ...
              if (searchedObject != null) {
               ...
               /*
                ...
                }else
                {
                  ...
                  activity.startActivity(new Intent(activity, com.bongbong.alprev.mlkit.md.java.PostingLinkActivity.class));
                }
                */
                ...
                for(int i=0; i < productList.size(); i++) {
                  //Toast.makeText(getApplicationContext(), productList.get(i).title, Toast.LENGTH_LONG).show();
                  Log.d(TAG, "Product Search: " + productList.get(i).title);

                }
                // setonclicklistner
                //productRecyclerView.setOnClickListener(new );
