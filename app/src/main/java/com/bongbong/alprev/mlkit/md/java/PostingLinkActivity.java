...
import com.bongbong.alprev.mlkit.md.java.LiveObjectCloudDetectionActivity;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
      switch (item.getItemId()) {
        ...
        case R.id.navigation_ok:
          ...
          activity1.startActivity(new Intent(activity1, com.bongbong.alprev.mlkit.ghost.view.LoginActivity.class));
          return true;
          /*
        ...
        case R.id.navigation_cancel:
          ...
          activity2.startActivity(new Intent(activity2, com.bongbong.alprev.mlkit.md.java.LiveObjectCloudDetectionActivity.class));
          return true;
      }
      return false;
    }
