...
//import com.bongbong.alprev.mlkit.md.java.PointLevelActivity;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
    if (requestCode == Utils.REQUEST_CODE_PHOTO_LIBRARY
        ...
        && data != null) {
      Intent intent = new Intent(this, com.bongbong.alprev.mlkit.md.java.StaticObjectDetectionActivity.class);
            ...
            view -> {
              ...
              switch (detectionMode) {
                ...
                case ODT_LIVE_MYPOINT:
                  activity.startActivity(new Intent(activity, com.bongbong.alprev.mlkit.md.java.PointActivity.class));
                  break;/*
                case ODT_LIVE_MYPOINTLEVEL:
                  activity.startActivity(new Intent(activity, com.bongbong.alprev.mlkit.md.java.PointLevelActivity.class));
                  break;

                //case ODT_LIVE_IMAGE:
                //  activity.startActivity(new Intent(activity, com.bongbong.alprev.mlkit.md.java.LiveObjectCloudImageDetectionActivity.class));
                //  break;
                case ODT_LIVE_TEXT:
                  //Utils.openImagePicker(activity);
                  activity.startActivity(new Intent(activity, com.bongbong.alprev.mlkit.md.java.LiveObjectCloudTextDetectionActivity.class));
                  break;

                case ODT_LIVE_LANDMARK:
                  activity.startActivity(new Intent(activity, com.bongbong.alprev.mlkit.md.java.LiveObjectCloudLandDetectionActivity.class));
                  break;
                //case ODT_LIVE_FACE:
                //  activity.startActivity(new Intent(activity, com.bongbong.alprev.mlkit.md.java.LiveObjectDetectionActivity.class));
                 // break;
                 */
                /*
                case ODT_LIVE:
